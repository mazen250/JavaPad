...
public class Notepad  implements ActionListener, MenuConstants
{
	...
	JMenuItem cutItem,copyItem, deleteItem, findItem, SearchWithGoogle, findNextItem, replaceItem, gotoItem, selectAllItem;
	/****/
	Notepad()
	{
...
//----------------------------------------------------------------------------------------
		...
		else if(cmdText.equals(editSearchWithGoogle))
		{
			try {

				URI uri = new URI("https://www.google.com/search?q="+Notepad.this.ta.getText()+"&source=hp&ei=_VrCYPPgJYTQaK7bm7gI&iflsig=AINFCbYAAAAAYMJpDVSyguzuPAeHffSGHor4jWExFJci&oq=heba&gs_lcp=&sclient=gws-wiz&ved=0ahUKEwiz06GH2o3xAhUEKBoKHa7tBocQ4dUDCAc&uact=5");
				//"https://www.google.com/search?q="+Notepad.this.ta.getText()+"&source=hp&ei=_VrCYPPgJYTQaK7bm7gI&iflsig=AINFCbYAAAAAYMJpDVSyguzuPAeHffSGHor4jWExFJci&oq=heba&gs_lcp=&sclient=gws-wiz&ved=0ahUKEwiz06GH2o3xAhUEKBoKHa7tBocQ4dUDCAc&uact=5"
...
//--------------------------------------------------------------------------------
		else if(cmdText.equals(helpViewHelp))
		{
			JOptionPane.showMessageDialog(Notepad.this.f,viewhelpText,"View Help",JOptionPane.INFORMATION_MESSAGE);
		}
//-------------------------------------------------------------------------------------
		else
	...
	void createMenuBar(JFrame f)
	{
		...
		SearchWithGoogle=createMenuItem(editSearchWithGoogle,KeyEvent.VK_F,editMenu,KeyEvent.VK_F,this);
...
//--------------------------------------------------------------------------------------
		createMenuItem(helpViewHelp,KeyEvent.VK_A,helpMenu,this);
//---------------------------------------------------------------------------------------
		MenuListener editMenuListener=new MenuListener()
		{
			public void menuSelected(MenuEvent evvvv)
			{
				if(Notepad.this.ta.getText().length()==0)
				{
					...
					SearchWithGoogle.setEnabled(false);
				...
				else
				{
					...
					SearchWithGoogle.setEnabled(true);
				...
				//	SearchWithBing.setEnabled(false);
...
interface MenuConstants
{
	...
	final String editSearchWithGoogle="SearchWithGoogle";
	...
	final String helpViewHelp="View Help";
	...
	//-------------------------------------------------------------------------------
	final String viewhelpText=
			"<html><big><center>Help in Javapad.</center></big>"
					+"<p align=center>Tips on how to use JavaPad:"

					+"<hr><p align=left><u>*New : </u><br>"
					+"<p align=left>To open new file Press - File -> New ->Choose new directory .<br>"

					+"<hr><p align=left><u>*Open : </u><br>"
					+"<p align=left>-To Open a saved file on your desktop Press file > Open or (ctrl+o) > then choose your file > Open this .<br>"

					+"<hr><p align=left><u>*Save  : </u><br>"
					+"<p align=left>-To save changes you can Press Ctrl+S for a shortcut . <br>"

					+"<hr><p align=left><u>*Save as : </u><br>"
					+"<p align=left>- To save file as a specific name press on file > save as > then choose a directory > save now .<br>"

					+"<hr><p align=left><u>*Print : </u><br>"
					+"<p align=left>- -To print the document you can Press Ctrl+P for a shortcut .<br>"

					+"<hr><p align=left><u>*Exit : </u><br>"
					+"<p align=left>- To exit the application you can Press alt+F4 for a shortcut.<br>"

					+"<hr><p align=left><u>*Undo : </u><br>"
					+"<p align=left>- Undo last move you can Press Ctrl+z for a shortcut.<br>"

					+"<hr><p align=left><u>*Cut : </u><br>"
					+"<p align=left>- To copy and delete selected statements you can press ctrl+X  .<br>"


					+"<hr><em><big><center>Thank you for using Javapad..</center></big></em><hr><html>";
	//----------------------------------------------------------------------------
}